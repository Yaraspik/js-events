...
var GamePlay = /*#__PURE__*/function () {
  ...
  _createClass(GamePlay, [{
    ...
    value: function cellClickHandler() {
...
/* harmony import */ var _position__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./position */ "./src/js/position.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    value: function drawGoblin() {
      ...
      var goblinPosition = (0,_position__WEBPACK_IMPORTED_MODULE_16__["default"])(this.goblinPosition, this.boardSize);
    ...
    key: "drawHit",
    value: function drawHit(index) {
      var _this3 = this;
      this.container.classList.add('game-container-hit');
      setTimeout(function () {
        _this3.container.classList.remove('game-container-hit');
      }, 100);
    ...
    */
    ...
    value: function showGameOver() {
      var popup = this.container.querySelector('.message-wrapper');
...
var gameCtrl = new _GameController__WEBPACK_IMPORTED_MODULE_1__["default"](gamePlay);
gameCtrl.init();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ createPosition)
/* harmony export */ });
function createPosition(curPosition, boardSize) {
  var newPosition = Math.floor(Math.random() * Math.pow(boardSize, 2));
  while (newPosition === curPosition) {
    newPosition = Math.floor(Math.random() * Math.pow(boardSize, 2));
  }
  return newPosition;
}
